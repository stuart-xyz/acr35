...
@subsection header MyViewController.h
...
@subsection source MyViewController.m
...
@subsection reset Resetting the reader
...
@subsection sleepmode Controlling the sleep mode
...
@subsection sleeptimeout Setting the sleep timeout
...
@subsection firmware Getting the firmware version
...
@subsection status Getting the status
...
@subsection raw Receiving the raw data
...
@subsection icc Working with the ICC
...
@subsection picc Working with the PICC
